...
| Context Mapper
| https://contextmapper.org/[Context Mapper] integration for jQAssistant to scan and create Context Maps to validate as-is against to-be architecture
| https://github.com/jqassistant-contrib/jqassistant-context-mapper-plugin[Homepage^]
| <<jQAssistant Contrib>>
